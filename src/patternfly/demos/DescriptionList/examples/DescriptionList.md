...
{{#*inline "page-template-section"}}
  {{#> page-main-section page-main-section--IsLimitWidth="true"}}
    {{#> card}}
      ...
      {{> divider}}
      {{#> card-body}}
        {{> description-list-template description-list--modifier="pf-m-auto-fit" description-list--attribute='aria-label="Details"'}}
      {{/card-body}}
    {{/card}}
  {{/page-main-section}}
{{/inline}}
...
{{#*inline "page-template-drawer-panel-tab-content"}}
  {{#> description-list description-list--attribute='aria-label="Overview"' description-list--modifier="pf-m-fill-columns pf-m-2-col pf-m-compact"}}
    ...
    {{#> grid grid--modifier="pf-m-gutter" l-flex-item--modifier=reset}}
      {{#> grid-item grid-item--modifier="pf-m-5-col-on-lg pf-m-4-col-on-xl"}}
        {{#> grid grid--modifier="pf-m-gutter" grid-item--modifier=reset}}
          ...
          {{/grid-item}}
          {{#> grid-item}}
            {{#> description-list description-list--attribute='aria-label="Service overview"' description-list--modifier="pf-m-2-col-on-xl"}}
              {{#> description-list-group}}
                {{#> description-list-term}}
                  {{#> description-list-text}}
                    Name
      ...
      {{#> grid-item grid-item--modifier="pf-m-6-col-on-lg pf-m-4-col-on-xl"}}
        {{#> grid grid--modifier="pf-m-gutter" grid-item--modifier=reset}}
          ...
          {{/grid-item}}
          {{#> grid-item}}
            {{#> description-list description-list--attribute='aria-label="Service routing"'}}
              {{#> description-list-group}}
                {{#> description-list-term}}
                  {{#> description-list-text}}
                    Service address
