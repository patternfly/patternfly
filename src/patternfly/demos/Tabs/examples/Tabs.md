    ...
    {{#> tabs--pod-tab-content tabs--pod-tab-content--id=(concat tabs--page-wrapper--id '-tabs-list')}}
      {{#> l-flex l-flex--modifier="pf-m-column"}}
        {{#> l-flex-item l-flex-item--modifier="pf-m-spacer-lg"}}
          {{> title titleType="h2" title--modifier="pf-m-lg pf-u-mt-sm" title--text="Pod details" title--attribute=(concat 'id="' tabs--pod-tab-content--id '-details-title"')}}
        {{/l-flex-item}}
        {{#> l-flex-item}}
          {{#> description-list description-list--modifier="pf-m-2-col-on-lg" description-list--attribute=(concat 'aria-labelledby="' tabs--pod-tab-content--id '-details-title"')}}
...
{{#> tabs--page-wrapper tabs--page-wrapper--id="open-with-secondary-tabs-example"}}
  ...
  {{#> page-main-section page-main-section--IsLimitWidth="true" page-main-section--modifier="pf-m-light"}}
    {{#> l-flex l-flex--modifier="pf-m-column"}}
      {{#> l-flex-item}}
        {{> tabs--pod-tab-list tabs--pod-tab-list--IsSecondary="true" tabs--pod-tab-list--id=(concat tabs--page-wrapper--id '-tabs-list-secondary') tabs--pod-tab-list--modifier=""}}
      {{/l-flex-item}}
      {{#> l-flex-item}}
        {{#> tabs--pod-tab-content tabs--pod-tab-content--id=(concat tabs--page-wrapper--id '-tabs-list')}}
          {{#> tabs--pod-tab-content tabs--pod-tab-content--id=(concat tabs--page-wrapper--id '-tabs-list-secondary') tabs--pod-tab-content--IsSecondary="true"}}
            {{#> l-flex l-flex--modifier="pf-m-column"}}
              {{#> l-flex-item}}
...
### Tables and tabs
```hbs isFullscreen
{{#> tabs--page-wrapper tabs--page-wrapper--id="table-tabs-example"}}
      ...
      {{#> drawer drawer--id=(concat tabs--page-wrapper--id '-tabs') primary-detail-template--id=(concat tabs--page-wrapper--id '-tabs') drawer-panel--IsOpen="true" drawer--modifier="pf-m-inline-on-2xlsss pf-m-inline"}}
        {{#> drawer-main}}
          ...
          {{#> drawer-panel drawer-panel--modifier="pf-m-width-33 pf-m-width-33-on-xl"}}
            ...
            {{/drawer-body}}
            {{#> drawer-body primary-detail-template--id=(concat tabs--page-wrapper--id '-tabs')}}
              {{> primary-detail-panel-tab-content progress--modifier="pf-m-sm" primary-detail-panel-tab-content--HasLabels="true"}}
            {{/drawer-body}}
          {{/drawer-panel}}
        {{/drawer-main}}
      {{/drawer}}
      ...
      {{#> drawer drawer--id=(concat tabs--page-wrapper--id '-tabs') primary-detail-template--id=(concat tabs--page-wrapper--id '-tabs') drawer-panel--IsOpen="true" drawer--modifier="pf-m-inline-on-2xlsss pf-m-inline"}}
        {{#> drawer-main}}
          ...
          {{#> drawer-panel drawer-panel--modifier="pf-m-width-33 pf-m-width-33-on-xl"}}
            {{> tabs--panel-header tabs--panel-header--title="Node 2" tabs--panel-header--sub-title='<a href="#">siemur/test-space</a>'}}
            {{#> drawer-body drawer-body--modifier="pf-m-no-padding"}}
              {{> primary-detail-panel-tabs primary-detail-panel-tabs--Has3="true" primary-detail-panel-tabs--modifier="pf-m-no-border-bottom pf-m-inset-md pf-m-inset-sm-on-md"}}
            {{/drawer-body}}
            {{#> drawer-body primary-detail-template--id=(concat tabs--page-wrapper--id '-tabs')}}
              {{> primary-detail-panel-tab-content progress--modifier="pf-m-sm" primary-detail-panel-tab-content--HasLabels="true" primary-detail-panel-tab-content--Has3="true"}}
            {{/drawer-body}}
          {{/drawer-panel}}
        {{/drawer-main}}
      {{/drawer}}
...
### Modal tabs
```hbs isFullscreen
{{#> example-wrapper example-wrapper--id="modal-tabs-example"}}
  {{#> modal}}
    {{#> backdrop}}
      {{#> bullseye}}
        {{#> modal-box modal-box--modifier="pf-m-sm" modal-box--attribute=(concat 'aria-labelledby="' example-wrapper--id '-modal-title" aria-describedby="' example-wrapper--id '-modal-description"')}}
          {{#> button button--modifier="pf-m-plain" button--attribute='aria-label="Close dialog"'}}
            <i class="fas fa-times" aria-hidden="true"></i>
          {{/button}}
          {{#> modal-box-header}}
            {{#> modal-box-title modal-box-title--attribute=(concat 'id="' example-wrapper--id '-modal-title"')}}
              Modal title
            {{/modal-box-title}}
          {{/modal-box-header}}
          {{#> modal-box-body modal-box-body--attribute=(concat 'id="' example-wrapper--id '-modal-description"')}}
            {{#> grid grid--modifier="pf-m-gutter"}}
              ...
              {{/grid-item}}
              {{#> grid-item}}
                {{#> tab-content tab-content--IsActive="true" tab-content--attribute=(concat 'aria-labelledby="' example-wrapper--id '-tabs-details-link" id="' example-wrapper--id '-tabs-details-panel"')}}
                ...
                {{/tab-content}}
                {{#> tab-content tab-content--attribute=(concat 'aria-labelledby="' example-wrapper--id '-tabs-documentation-link" id="' example-wrapper--id '-tabs-documentation-panel"')}}
    ...
    {{/backdrop}}
  {{/modal}}
  {{#> tabs--page-wrapper example-wrapper--id="table-tabs-w-secondary-example"}}
    {{#> page-main-section page-main-section--IsLimitWidth="true" page-main-section--modifier="pf-m-light"}}
      {{#> content}}
        <h1>Projects</h1>
...
```hbs isFullscreen
{{#> tabs--page-wrapper tabs--page-wrapper--id="nested-unindented-tabs-example"}}
  {{#> page-main-section page-main-section--IsLimitWidth="true" page-main-section--modifier="pf-m-light"}}
  ...
  {{#> page-main-section page-main-section--IsLimitWidth="true" tab-content--id=(concat tabs--page-wrapper--id '-tabs') page-main-section--modifier="pf-m-light"}}
    ...
    {{#> tab-content tab-content--IsActive="true" tab-content--attribute=(concat 'aria-labelledby="' tab-content--id '-get-started-link" id="' tab-content--id '-get-started-panel"')}}
      {{#> grid grid--modifier="pf-m-gutter"}}
        ...
        {{/grid-item}}
        {{#> grid-item}}
          {{#> tabs tabs--id=(concat tabs--page-wrapper--id '-subtabs') tabs--modifier="pf-m-inset-none pf-m-secondary"}}
            {{#> tabs-list}}
              {{> __tabs-item
                __tabs-item--current="true"
                __tabs-item--id="x86"
        ...
        {{/grid-item}}
        {{#> grid-item}}
          {{#> example-wrapper tab-content--id=(concat tabs--page-wrapper--id '-subtabs')}}
