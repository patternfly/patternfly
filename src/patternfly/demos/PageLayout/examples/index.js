...
import PageLayoutDefaultNavHeaderExampleRaw from '!raw!./page-layout-default-nav-header-example.hbs';
...
import PageLayoutDefaultNavHeaderExample from './page-layout-default-nav-header-example.hbs';
...
export default () => {
  const pageLayoutDefaultNavHeaderExample = PageLayoutDefaultNavHeaderExample();
  ...
  return (
    <Documentation docs={Docs} heading={headingText}>
      <Example
        heading="Page Layout Default Nav Header Example"
        fullPageOnly="true"
        handlebars={PageLayoutDefaultNavHeaderExampleRaw}
      >
        {pageLayoutDefaultNavHeaderExample}
      </Example>
      <Example
