  ...
  {{#> grid grid--modifier="pf-m-gutter"}}
    {{#> grid-item grid-item--modifier="pf-m-6-col-on-md"}}
      {{#> form-group}}
        ...
        {{/form-group-label}}
        {{#> form-group-control}}
          {{#> form-control controlType="input" input="true" form-control--attribute='required type="text" id="simple-form-first-name" name="simple-form-first-name"'}}{{/form-control}}
        {{/form-group-control}}
      {{/form-group}}
    {{/grid-item}}
    {{#> grid-item grid-item--modifier="pf-m-6-col-on-md"}}
       {{#> form-group}}
        ...
        {{/form-group-label}}
        {{#> form-group-control}}
          {{#> form-control controlType="input" input="true" form-control--attribute='required type="text" id="simple-form-last-name" name="simple-form-last-name"'}}{{/form-control}}
        {{/form-group-control}}
      {{/form-group}}
    {{/grid-item}}
    {{#> grid-item grid-item--modifier="pf-m-6-col-on-md"}}
      {{#> form-group}}
        ...
        {{/form-group-label}}
        {{#> form-group-control}}
          {{#> form-control controlType="input" input="true" form-control--attribute='required type="text" id="simple-form-phone" name="simple-form-phone"'}}{{/form-control}}
        {{/form-group-control}}
      {{/form-group}}
    {{/grid-item}}
    {{#> grid-item grid-item--modifier="pf-m-6-col-on-md"}}
      {{#> form-group}}
        ...
        {{/form-group-label}}
        {{#> form-group-control}}
          {{#> form-control controlType="input" input="true" form-control--attribute='required type="text" id="simple-form-email" name="simple-form-email"'}}{{/form-control}}
        {{/form-group-control}}
      {{/form-group}}
    {{/grid-item}}
    {{#> grid-item grid-item--modifier="pf-m-6-col-on-md"}}
      {{#> form-group}}
        ...
        {{/form-group-label}}
        {{#> form-group-control}}
          {{#> form-control controlType="input" input="true" form-control--attribute='required type="text" id="simple-form-address" name="simple-form-address"'}}{{/form-control}}
        {{/form-group-control}}
      {{/form-group}}
    {{/grid-item}}
    {{#> grid-item grid-item--modifier="pf-m-6-col-on-sm pf-m-3-col-on-md"}}
      {{#> form-group}}
        {{#> form-group-label}}
          {{#> form-label form-label--attribute='for="simple-form-city"' required="true"}}City{{/form-label}}
        {{/form-group-label}}
        {{#> form-group-control}}
          {{#> form-control controlType="input" input="true" form-control--attribute='required type="text" id="simple-form-city" name="simple-form-city"'}}{{/form-control}}
        {{/form-group-control}}
      {{/form-group}}
    {{/grid-item}}
    {{#> grid-item grid-item--modifier="pf-m-6-col-on-sm pf-m-3-col-on-md"}}
      {{#> form-group}}
        {{#> form-group-label}}
          {{#> form-label form-label--attribute='for="simple-form-state"' required="true"}}State{{/form-label}}
        {{/form-group-label}}
        {{#> form-group-control}}
          {{#> form-control controlType="input" input="true" form-control--attribute='required type="text" id="simple-form-state" name="simple-form-state"'}}{{/form-control}}
        {{/form-group-control}}
      {{/form-group}}
    {{/grid-item}}
  {{/grid}}
