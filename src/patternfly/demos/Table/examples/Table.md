...
{{#> page page--id="sticky-first-column-demo"}}
  ...
  {{#> page-sidebar}}
    {{> table-page-nav}}
  {{/page-sidebar}}
  {{#> page-main page-main--modifier="pf-m-limit-heightsss" page-main--attribute=(concat 'id="main-content-' page--id '"')}}
    ...
    {{#> page-main-section page-main-section--modifier="pf-m-light" page-main-section--IsLimitWidths="true"}}
      ...
      {{/content}}
    {{/page-main-section}}
    {{#> page-main-section page-main-section--modifier="pf-m-no-padding pf-m-padding-on-xl pf-m-limit-height" page-main-section--IsLimitWidth="true"}}
      <div class="pf-c-sticky-table-container">
        ...
        <div class="pf-c-table-scroll-wrapper">
          {{> table--scrollable table--scrollable--id="sticky-first-column-demo-table" table--scrollable--Column1IsStickyColumn="true"}}
        </div>
  ...
  {{#> page-main page-main--modifier="pf-m-limit-heightsss" page-main--attribute=(concat 'id="main-content-' page--id '"')}}
    ...
    {{#> page-main-section page-main-section--modifier="pf-m-no-padding pf-m-padding-on-xl pf-m-limit-height" page-main-section--IsLimitWidth="true"}}
      <div class="pf-c-sticky-table-container">
        {{> toolbar--template toolbar--id=(concat page--id '-toolbar') toolbar--template--HasBulkSelect="true" toolbar--template--HasToggleGroup="true" toolbar--template--HasSearchFilter="true" toolbar--template--HasSortButton="true" toolbar--template--HasOverflowMenu="true"}}
        <div class="pf-c-table-scroll-wrapper">
          {{> table--scrollable table--scrollable--id="sticky-multiple-columns-demo-table" table--scrollable--Column1IsStickyColumn="true" table--scrollable--Column2IsStickyColumn="true"}}
        </div>
        {{> table-pagination-footer}}
      </div>
    {{/page-main-section}}
  ...
  {{#> page-main page-main--modifier="pf-m-limit-heightsss" page-main--attribute=(concat 'id="main-content-' page--id '"')}}
    ...
    {{#> page-main-section page-main-section--modifier="pf-m-no-padding pf-m-padding-on-xl pf-m-limit-height" page-main-section--IsLimitWidth="true"}}
      ...
      <div class="pf-c-sticky-table-container">
        {{> toolbar--template toolbar--id=(concat page--id '-toolbar') toolbar--template--HasBulkSelect="true" toolbar--template--HasToggleGroup="true" toolbar--template--HasSearchFilter="true" toolbar--template--HasSortButton="true" toolbar--template--HasOverflowMenu="true"}}
        <div class="pf-c-table-scroll-wrapper">
          {{> table--scrollable table--scrollable--id="sticky-header-and-multiple-columns-demo-table" table--scrollable--modifier="pf-m-sticky-header" table--scrollable--Column1IsStickyColumn="true" table--scrollable--Column2IsStickyColumn="true"}}
        </div>
        {{> table-pagination-footer}}
      </div>
      {{/card}}
...
{{#> page page--id="page-layout-table-simple"}}
  ...
  {{#> page-main page-main--attribute=(concat 'id="main-content-' page--id '"')}}
    {{#> page-main-section page-main-section--modifier="pf-m-light" page-main-section--IsLimitWidth="true"}}
      ...
      {{/content}}
    {{/page-main-section}}
    {{#> page-main-section page-main-section--modifier="" page-main-section--IsLimitWidth="true"}}
      {{#> card}}
        {{> toolbar--template toolbar--template--modifier="pf-m-page-insets" toolbar--id=(concat page--id '-toolbar') toolbar--template--HasBulkSelect="true" toolbar--template--HasToggleGroup="true" toolbar--template--HasSearchFilter="true" toolbar--template--HasSortButton="true" toolbar--template--HasOverflowMenu="true"}}
        {{#> card-body}}
          {{> table--scrollable}}
        {{/card-body}}
        {{> table-pagination-footer}}
