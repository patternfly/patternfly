...
```hbs
{{#> sizing-min-max sizing-min-max--modifier="pf-v5-u-min-height pf-v5-u-max-height" sizing-min-max--attribute='style="--pf-v5-u-min-height--MinHeight: 20ch; --pf-v5-u-max-height--MaxHeight: 30ch; --pf-v6-u-max-height--MaxHeight-on-md: 50ch; --pf-v6-u-max-height--MaxHeight-on-xl: 70ch;"'}}
