The overflow menu component condenses several actions into a single dropdown button, then exposes those actions at a defined breakpoint `.pf-m-show{-on-[md, lg, xl]}`.
