...
{{#> calendar-month calendar-month--id="calendar-month-date-selected"}}
  {{#> calendar-month-header}}
    {{#> calendar-month-header-nav calendar-month-header-nav--modifier="pf-m-prev-month"}}
    ...
    {{/calendar-month-header-year}}
    {{#> calendar-month-header-nav calendar-month-header-nav--modifier="pf-m-next-month"}}
