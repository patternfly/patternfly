...
| `.pf-m-custom` | `.pf-v6-c-modal-box` | Modifies for the custom alert state. |
| `.pf-m-info` | `.pf-v6-c-modal-box` | Modifies for the info alert state. |
| `.pf-m-success` | `.pf-v6-c-modal-box` | Modifies for the success alert state. |
| `.pf-m-warning` | `.pf-v6-c-modal-box` | Modifies for the warning alert state. |
| `.pf-m-danger` | `.pf-v6-c-modal-box` | Modifies for the danger alert state. |
