...
| `.pf-v6-c-drawer__content` | `<div>` | Initiates the drawer content container. **Required** except when `.pf-m-viewport` is used as a viewport overlay. |
...
| `.pf-m-viewport` | `.pf-v6-c-drawer` | Positions the panel as `fixed` to fill the viewport height. Works in page main and as `.pf-v6-c-page__drawer` beside masthead, sidebar, and main. `.pf-v6-c-drawer__content` is optional with this modifier. |
