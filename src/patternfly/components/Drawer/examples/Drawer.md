...
| `.pf-m-viewport` | `.pf-v6-c-drawer` | Positions the panel as `fixed` to fill the viewport height. Place the drawer after `.pf-v6-c-page` as a sibling. `.pf-v6-c-drawer__content` is optional with this modifier. |
