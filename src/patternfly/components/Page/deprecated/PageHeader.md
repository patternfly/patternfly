...
{{#> page}}
  ...
  {{#> page-main}}
    {{#> page-main-section page-main-section--modifier="pf-m-dark-100"}}
      This <code>.pf-v6-c-page__main-section</code> uses <code>.pf-m-dark-100</code>.
    {{/page-main-section}}
    {{#> page-main-section page-main-section--modifier="pf-m-dark-200"}}
      This <code>.pf-v6-c-page__main-section</code> uses <code>.pf-m-dark-200</code>.
    {{/page-main-section}}
    {{#> page-main-section page-main-section--modifier="pf-m-light"}}
      This <code>.pf-v6-c-page__main-section</code> uses <code>.pf-m-light</code>.
    {{/page-main-section}}
    {{#> page-main-section}}
