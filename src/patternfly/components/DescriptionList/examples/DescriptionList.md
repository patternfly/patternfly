...
| `--pf-c-description-list--GridTemplateColumns--min{-on-[breakpoint]}: {width}px,rem,em` | `.pf-c-description-list` | Modifies the min value of the `grid-template-columns` declaration. |
| `--pf-c-description-list__term--width{-on-[breakpoint]}: {width}px,rem,em` | `.pf-c-description-list.pf-m-horizontal` | Modifies the value for `--pf-c-description-list--m-horizontal__term--width` declaration. |
