module.exports = {
  ...
  '/components/avatar/html': {
    id: "Avatar",
    title: "Avatar",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"Bordered - light"},{"text":"Bordered - dark"},{"text":"Small"},{"text":"Medium"},{"text":"Large"},{"text":"Extra large"}],{"text":"Documentation"},[{"text":"Overview"},{"text":"Accessibility"},{"text":"Usage"}]],
    examples: ["Basic","Bordered - light","Bordered - dark","Small","Medium","Large","Extra large"],
    section: "components",
    source: "html",
  ...
  '/components/code-editor/html': {
    id: "Code editor",
    title: "Code editor",
    toc: [{"text":"Examples"},[{"text":"Default"},{"text":"Read-only"},{"text":"Without actions"},{"text":"Drag file and hover over component"},{"text":"With optional header content and keyboard shortcuts"}],{"text":"Documentation"},[{"text":"Overview"},{"text":"Accessibility"},{"text":"Usage"}]],
    examples: ["Default","Read-only","Without actions","Drag file and hover over component","With optional header content and keyboard shortcuts"],
    section: "components",
    source: "html",
  ...
  '/components/divider/html': {
    id: "Divider",
    title: "Divider",
    toc: [{"text":"Examples"},[{"text":"hr"},{"text":"li"},{"text":"div"},{"text":"Inset medium"},{"text":"Md inset, no inset on md, 3xl inset on lg, lg inset on xl"},{"text":"Vertical"},{"text":"Vertical, inset medium"},{"text":"Vertical, md inset, no inset on md, lg inset on lg, sm inset on xl"},{"text":"Vertical on lg"},{"text":"Horizontal on lg"}],{"text":"Documentation"},[{"text":"Overview"},{"text":"Usage"}]],
    examples: ["hr","li","div","Inset medium","Md inset, no inset on md, 3xl inset on lg, lg inset on xl","Vertical","Vertical, inset medium","Vertical, md inset, no inset on md, lg inset on lg, sm inset on xl","Vertical on lg","Horizontal on lg"],
    section: "components",
    source: "html",
  ...
  '/components/dropdown/html': {
    id: "Dropdown",
    title: "Dropdown",
    toc: [{"text":"Examples"},[{"text":"Expanded"},{"text":"Collapsed"},{"text":"Disabled"},{"text":"Aria disabled items"},{"text":"Kebab"},{"text":"Kebab align right"},{"text":"Align right"},{"text":"Align on different breakpoint"},{"text":"Align top"},{"text":"Plain with text"},{"text":"Badge toggle"},{"text":"Menu item icons"},{"text":"Split button (checkbox)"},{"text":"Split button (checkbox with toggle text)"},{"text":"Split button (action)"},{"text":"Split button, primary (action)"},{"text":"Split button, secondary (action)"},{"text":"With groups"},{"text":"With groups and dividers between groups"},{"text":"With groups and dividers between items"},{"text":"Panel"},{"text":"Primary toggle"},{"text":"Secondary toggle"},{"text":"Dropdown with image and text"},{"text":"Dropdown with description"}],{"text":"Documentation"},[{"text":"Overview"},{"text":"Accessibility"},{"text":"Usage"}]],
    examples: ["Expanded","Collapsed","Disabled","Aria disabled items","Kebab","Kebab align right","Align right","Align on different breakpoint","Align top","Plain with text","Badge toggle","Menu item icons","Split button (checkbox)","Split button (checkbox with toggle text)","Split button (action)","Split button, primary (action)","Split button, secondary (action)","With groups","With groups and dividers between groups","With groups and dividers between items","Panel","Primary toggle","Secondary toggle","Dropdown with image and text","Dropdown with description"],
    section: "components",
    source: "html",
  ...
  '/components/form/html': {
    id: "Form",
    title: "Form",
    toc: [{"text":"Examples"},[{"text":"Vertically aligned labels"},{"text":"Horizontally aligned labels"},{"text":"Horizontal layout at a custom breakpoint"},{"text":"Form sections"},{"text":"Help text"},{"text":"Label with additional info"},{"text":"Action group"},{"text":"Field group (non-expandable)"},{"text":"Expandable and nested field groups"}],{"text":"Documentation"},[{"text":"Accessibility"},{"text":"Usage"}]],
    examples: ["Vertically aligned labels","Horizontally aligned labels","Horizontal layout at a custom breakpoint","Form sections","Help text","Label with additional info","Action group","Field group (non-expandable)","Expandable and nested field groups"],
    section: "components",
    source: "html",
  ...
  '/components/form-control/html': {
    id: "Form control",
    title: "Form control",
    toc: [{"text":"Examples"},[{"text":"Input"},{"text":"Select"},{"text":"Textarea"},{"text":"Icon sprite"}],{"text":"Documentation"},[{"text":"Accessibility"},{"text":"Usage"}]],
    examples: ["Input","Select","Textarea","Icon sprite"],
    section: "components",
    source: "html",
  ...
  '/components/input-group/html': {
    id: "Input group",
    title: "Input group",
    toc: [[{"text":"Overview"}],{"text":"Examples"},[{"text":"Variations"}],{"text":"Documentation"},[{"text":"Accessibility"},{"text":"Usage"}]],
    examples: ["Variations"],
    section: "components",
    source: "html",
  ...
  '/components/label/html': {
    id: "Label",
    title: "Label",
    toc: [{"text":"Examples"},[{"text":"Filled"},{"text":"Outline"},{"text":"Compact"},{"text":"Overflow"},{"text":"Editable"},{"text":"Add label"}],{"text":"Documentation"},[{"text":"Usage"}]],
    examples: ["Filled","Outline","Compact","Overflow","Editable","Add label"],
    section: "components",
    source: "html",
  ...
  '/components/label-group/html': {
    id: "Label group",
    title: "Label group",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"Overflow"},{"text":"Overflow expanded"},{"text":"Add label"},{"text":"Category"},{"text":"Category removable"},{"text":"Vertical"},{"text":"Vertical overflow"},{"text":"Vertical overflow expanded"},{"text":"Vertical category"},{"text":"Vertical category removable"},{"text":"Editable labels, dynamic label group"},{"text":"Editable labels, label active, dynamic label group"},{"text":"Static labels, dynamic label group"},{"text":"Mixed labels (static / editable), dynamic label group"},{"text":"Compact labels"},{"text":"Compact labels, overflow"},{"text":"Compact labels, vertical"}],{"text":"Documentation"},[{"text":"Accessibility"},{"text":"Usage"}]],
    examples: ["Basic","Overflow","Overflow expanded","Add label","Category","Category removable","Vertical","Vertical overflow","Vertical overflow expanded","Vertical category","Vertical category removable","Editable labels, dynamic label group","Editable labels, label active, dynamic label group","Static labels, dynamic label group","Mixed labels (static / editable), dynamic label group","Compact labels","Compact labels, overflow","Compact labels, vertical"],
    section: "components",
    source: "html",
  ...
  '/components/login-page/html': {
    id: "Login page",
    title: "Login page",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"Invalid"},{"text":"Show password"},{"text":"Hide password"},{"text":"With language selector"}],{"text":"Documentation"},[{"text":"Usage"}]],
    fullscreenExamples: ["Basic","Invalid","Show password","Hide password","With language selector"],
    section: "components",
    source: "html",
  ...
  '/components/menu-toggle/html': {
    id: "Menu toggle",
    title: "Menu toggle",
    toc: [{"text":"Examples"},[{"text":"Collapsed"},{"text":"Expanded"},{"text":"Disabled"},{"text":"Count"},{"text":"Primary"},{"text":"Secondary"},{"text":"Plain"},{"text":"Plain with text"},{"text":"Split button (checkbox)"},{"text":"Split button (checkbox with toggle text)"},{"text":"Split button, primary"},{"text":"Split button, secondary"},{"text":"Split button (action)"},{"text":"Split button, primary (action)"},{"text":"Split button, secondary (action)"},{"text":"With icon/image and text"},{"text":"With avatar and text"},{"text":"Full height"},{"text":"Typeahead"},{"text":"Accessibility"},{"text":"Usage"}]],
    examples: ["Collapsed","Expanded","Disabled","Count","Primary","Secondary","Plain","Plain with text","Split button (checkbox)","Split button (checkbox with toggle text)","Split button, primary","Split button, secondary","Split button (action)","Split button, primary (action)","Split button, secondary (action)","With icon/image and text","With avatar and text","Full height","Typeahead"],
    section: "components",
    source: "html",
  ...
  '/components/page/html': {
    id: "Page",
    title: "Page",
    toc: [{"text":"Examples"},[{"text":"Vertical nav"},{"text":"Horizontal nav"},{"text":"With or without fill"},{"text":"Main section padding"},{"text":"Main section variations"},{"text":"Centered section"}],{"text":"Documentation"},[{"text":"Overview"},{"text":"Accessibility"},{"text":"Usage"}]],
    examples: ["Vertical nav","Horizontal nav","With or without fill","Main section padding","Main section variations","Centered section"],
    section: "components",
    source: "html",
  ...
  '/components/spinner/html': {
    id: "Spinner",
    title: "Spinner",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"Sizes"},{"text":"Custom size"},{"text":"Basic (legacy)"},{"text":"Sizes (legacy)"}],{"text":"Documentation"},[{"text":"Accessibility"},{"text":"Usage"},{"text":"Usage (legacy)"},{"text":"Modifiers"}]],
    examples: ["Basic","Sizes","Custom size","Basic (legacy)","Sizes (legacy)"],
    section: "components",
    source: "html",
  ...
  '/components/switch/html': {
    id: "Switch",
    title: "Switch",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"Reverse (toggle on right)"},{"text":"Label and check"},{"text":"Without label"},{"text":"Disabled"}],{"text":"Documentation"},[{"text":"Overview"},{"text":"Accessibility"},{"text":"Usage"}]],
    examples: ["Basic","Reverse (toggle on right)","Label and check","Without label","Disabled"],
    section: "components",
    source: "html",
  ...
  '/components/table/html': {
    id: "Table",
    title: "Table",
    toc: [{"text":"Basic table"},[{"text":"Basic table example"},{"text":"Basic table accessibility"},{"text":"Basic table usage"}],{"text":"Responsive table behavior"},[{"text":"Responsive layout modifier usage"}],{"text":"Sortable"},[{"text":"Sortable example"},{"text":"Sortable accessibility"},{"text":"Sortable usage"},{"text":"Overflow menu usage, desktop"},{"text":"Overflow menu usage, overflow menu collapsed"},{"text":"Overflow menu usage, mobile"}],{"text":"With checkboxes, radio select, and actions"},[{"text":"Checkboxes and actions example"},{"text":"Single select radio example"},{"text":"Checkboxes, radio select, and actions accessibility"},{"text":"Checkboxes, radio select, and actions usage"}],{"text":"Expandable"},[{"text":"Expandable example"},{"text":"Expandable with set width columns example"},{"text":"Expandable with nested table example"},{"text":"Expandable accessibility"},{"text":"Expandable usage"}],{"text":"Compound expansion"},[{"text":"Compound expansion example"},{"text":"Compound expansion accessibility"},{"text":"Compound expansion usage"}],{"text":"Compact variant"},[{"text":"Compact example"},{"text":"Compact expandable example"},{"text":"Compact Usage"}],{"text":"Hoverable and selected"},[{"text":"Hoverable and selected example"},{"text":"Expandable, hoverable, and selected example"},{"text":"Hoverable accessibility"},{"text":"Hoverable and selected usage"}],{"text":"Tree table"},[{"text":"Tree table basic"},{"text":"Tree table with checkboxes"},{"text":"Tree table with checkboxes and icons"},{"text":"Tree table accessibility"},{"text":"Tree table usage"}],{"text":"Borderless variant"},[{"text":"Borderless example"},{"text":"Borderless compact example"},{"text":"Borderless expandable example"},{"text":"Borderless with compound expansion example"},{"text":"Borderless usage"}],{"text":"Width modifiers"},[{"text":"Width modifiers examples"},{"text":"Width modifiers usage"}],{"text":"Hidden/visible breakpoint modifiers"},[{"text":"Hidden/visible breakpoint modifiers example"},{"text":"Hidden/visible breakpoint modifiers usage"}],{"text":"Text control modifiers"},[{"text":"Text control example"},{"text":"Text control using the table text element example"},{"text":"Table with long strings in the content"},{"text":"Width constrained"},{"text":"Text control modifiers usage"}],{"text":"Sticky table modifiers"},[{"text":"Sticky header"},{"text":"Sticky column"},{"text":"Multiple sticky columns"},{"text":"Sticky columns and header"},{"text":"Sticky table usage"}],{"text":"Nested column headers"},[{"text":"Nested column headers and expandable rows"},{"text":"Nested column headers example"},{"text":"Nested column headers, sticky header"},{"text":"Nested column header modifier usage"}],{"text":"Favorites"},[{"text":"Favorites examples"},{"text":"Favorites sortable example"},{"text":"Favorites accessibility"},{"text":"Favorites usage"}],{"text":"Draggable rows"},[{"text":"Draggable rows example"},{"text":"Draggable rows accessibility"},{"text":"Draggable rows usage"}],{"text":"Striped"},[{"text":"Striped table example"},{"text":"Striped expandable table example"},{"text":"Striped multiple tbody example"},{"text":"Striped tr example"},{"text":"Striped table usage"}],{"text":"Documentation"},[{"text":"Overview"},{"text":"Role=\"grid\""},{"text":"Sortable tables"},{"text":"Table header cells"},{"text":"Implementation support"}]],
    examples: ["Basic table example","Sortable example","Overflow menu usage, desktop","Overflow menu usage, overflow menu collapsed","Overflow menu usage, mobile","Checkboxes and actions example","Single select radio example","Expandable example","Expandable with set width columns example","Expandable with nested table example","Compound expansion example","Compact example","Compact expandable example","Hoverable and selected example","Expandable, hoverable, and selected example","Tree table basic","Tree table with checkboxes","Tree table with checkboxes and icons","Borderless example","Borderless compact example","Borderless expandable example","Borderless with compound expansion example","Width modifiers examples","Hidden/visible breakpoint modifiers example","Text control example","Text control using the table text element example","Table with long strings in the content","Width constrained","Sticky header","Sticky column","Multiple sticky columns","Sticky columns and header","Nested column headers and expandable rows","Nested column headers example","Nested column headers, sticky header","Favorites examples","Favorites sortable example","Draggable rows example","Striped table example","Striped expandable table example","Striped multiple tbody example","Striped tr example"],
    section: "components",
    source: "html",
  ...
  '/components/tabs/html': {
    id: "Tabs",
    title: "Tabs",
    toc: [{"text":"Examples"},[{"text":"Default"},{"text":"Accessibility"},{"text":"Usage"},{"text":"Default overflow beginning of list"},{"text":"Accessibility","id":"accessibility-0"},{"text":"Usage","id":"usage-0"},{"text":"Horizontal overflow"},{"text":"Horizontal overflow expanded"},{"text":"Horizontal overflow selected"},{"text":"Vertical"},{"text":"Box"},{"text":"Box overflow"},{"text":"Box vertical"},{"text":"Box tabs color scheme light 300"},{"text":"Inset"},{"text":"Inset box"},{"text":"Page insets"},{"text":"Usage","id":"usage-1"},{"text":"Icons and text"},{"text":"Tabs with sub tabs"},{"text":"Box tabs with sub tabs"},{"text":"Filled"},{"text":"Filled with icons"},{"text":"Filled box"},{"text":"Filled box with icons"}],{"text":"Usage","id":"usage-2"},[{"text":"Using the nav element"},{"text":"Sub nav using the nav element"},{"text":"Vertical expandable"},{"text":"Vertical expanded"},{"text":"Vertical expandable (responsive)"},{"text":"Vertical expandable (legacy)"},{"text":"Vertical expanded (legacy)"},{"text":"Vertical expandable (responsive, legacy)"},{"text":"Close button"},{"text":"Add tab button"},{"text":"Accessibility","id":"accessibility-1"},{"text":"Usage","id":"usage-3"}]],
    examples: ["Default","Default overflow beginning of list","Horizontal overflow","Horizontal overflow expanded","Horizontal overflow selected","Vertical","Box","Box overflow","Box vertical","Box tabs color scheme light 300","Inset","Inset box","Page insets","Icons and text","Tabs with sub tabs","Box tabs with sub tabs","Filled","Filled with icons","Filled box","Filled box with icons","Using the nav element","Sub nav using the nav element","Vertical expandable","Vertical expanded","Vertical expandable (responsive)","Vertical expandable (legacy)","Vertical expanded (legacy)","Vertical expandable (responsive, legacy)","Close button","Add tab button"],
    section: "components",
    source: "html",
  ...
  '/components/toolbar/html': {
    id: "Toolbar",
    title: "Toolbar",
    toc: [{"text":"Introduction"},[{"text":"Default spacing for items and groups:"},{"text":"Toolbar item types"},{"text":"Modifiers"},{"text":"Special notes"}],{"text":"Examples"},[{"text":"Simple"},{"text":"Item types"},{"text":"Spacers"},{"text":"Adjusted spacers"},{"text":"Adjusted group spacers"},{"text":"Insets"},{"text":"Page insets"},{"text":"Toolbar spacers and insets"},{"text":"Width control"},{"text":"Width control usage"},{"text":"Group types"},{"text":"Toolbar group types"},{"text":"Toggle group"},{"text":"Toggle group on mobile (filters collapsed, expandable content expanded)"},{"text":"Toggle group modifier"},{"text":"Accessibility"},{"text":"Responsive attributes"},{"text":"Usage"},{"text":"Selected"},{"text":"Selected filters on mobile (filters collapsed, selected filters summary visible)"},{"text":"Selected filters on mobile (filters collapsed, expandable content expanded)"},{"text":"Selected filters on desktop (not responsive)"},{"text":"Stacked"},{"text":"Stacked on desktop"},{"text":"Stacked on mobile (filters collapsed, expandable content expanded)"},{"text":"Expanded elements"}],{"text":"Documentation"},[{"text":"Overview"},{"text":"Usage","id":"usage-0"},{"text":"Accessibility","id":"accessibility-0"},{"text":"Toggle group usage"},{"text":"Spacer system"}]],
  ...
  '/components/wizard/html': {
    id: "Wizard",
    title: "Wizard",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"Nav expanded (mobile)"},{"text":"With drawer"},{"text":"Expandable collapsed"},{"text":"Expandable expanded"},{"text":"Finished"}],{"text":"Documentation"},[{"text":"Accessibility"},{"text":"Usage"}]],
    fullscreenExamples: ["Basic","Nav expanded (mobile)","With drawer","Expandable collapsed","Expandable expanded","Finished"],
    section: "components",
    source: "html",
  ...
  '/layouts/grid/html': {
    id: "Grid",
    title: "Grid",
    toc: [{"text":"Examples"},[{"text":"Smart (responsive)"},{"text":"Smart with overrides (responsive)"},{"text":"Base"},{"text":"Gutter"},{"text":"Responsive"},{"text":"Nested"},{"text":"Offsets"},{"text":"Row spans"},{"text":"Ordering"},{"text":"Ordering example"},{"text":"Responsive ordering"},{"text":"Grouped ordering"},{"text":"Grouped, responsive ordering"},{"text":"List type"}],{"text":"Documentation"},[{"text":"Overview"},{"text":"Usage"}]],
    examples: ["Smart (responsive)","Smart with overrides (responsive)","Base","Gutter","Responsive","Nested","Offsets","Row spans","Ordering example","Responsive ordering","Grouped ordering","Grouped, responsive ordering","List type"],
    section: "layouts",
    source: "html",
  ...
  '/utilities/text/html': {
    id: "Text",
    title: "Text",
    toc: [{"text":"Examples"},[{"text":"Font family"},{"text":"Font size"},{"text":"Font weight"},{"text":"Standard colors"},{"text":"Inverse colors"},{"text":"Link colors"},{"text":"Status and state text colors"},{"text":"Disabled text colors"},{"text":"Icon colors"},{"text":"Controlling text"}],{"text":"Documentation"},[{"text":"Overview"},{"text":"Usage"}]],
    examples: ["Font family","Font size","Font weight","Standard colors","Inverse colors","Link colors","Status and state text colors","Disabled text colors","Icon colors","Controlling text"],
    section: "utilities",
    source: "html",
  ...
  '/demos/dashboard/html-demos': {
    ...
    section: "demos",
    source: "html-demos",
    Component: () => import(/* webpackChunkName: "demos/dashboard/html-demos/index" */ './demos/dashboard/html-demos')
  },
  '/components/data-list/html-demos': {
    id: "Data list",
    title: "Data list",
    toc: [{"text":"Demos"},[{"text":"Basic"},{"text":"Actionable"},{"text":"Expandable demo"},{"text":"Static bottom pagination"}]],
    fullscreenExamples: ["Basic","Actionable","Expandable demo","Static bottom pagination"],
    section: "components",
    source: "html-demos",
    Component: () => import(/* webpackChunkName: "components/data-list/html-demos/index" */ './components/data-list/html-demos')
  },
  '/components/description-list/html-demos': {
    id: "Description list",
    title: "Description list",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"In drawer"},{"text":"Complex content"}]],
    fullscreenExamples: ["Basic","In drawer","Complex content"],
    section: "components",
    source: "html-demos",
    Component: () => import(/* webpackChunkName: "components/description-list/html-demos/index" */ './components/description-list/html-demos')
  },
  '/components/drawer/html-demos': {
    id: "Drawer",
    title: "Drawer",
    toc: [{"text":"Demos"},[{"text":"Collapsed"},{"text":"Expanded"},{"text":"Expanded bottom"},{"text":"Drawer with jump links"},{"text":"Expanded drawer with jump links"}],{"text":"Documentation"}],
    fullscreenExamples: ["Collapsed","Expanded","Expanded bottom","Drawer with jump links","Expanded drawer with jump links"],
    section: "components",
    source: "html-demos",
  ...
  '/components/form/html-demos': {
    id: "Form",
    title: "Form",
    toc: [{"text":"Demos"},[{"text":"Basic"},{"text":"Horizontal"},{"text":"Grid"},{"text":"Sections with repeatable fields"},{"text":"Complex form"}]],
    examples: ["Basic","Horizontal","Grid","Sections with repeatable fields","Complex form"],
    section: "components",
    source: "html-demos",
  ...
  '/components/jump-links/html-demos': {
    id: "Jump links",
    title: "Jump links",
    toc: [{"text":"Examples"},[{"text":"Vertical jump links collapsed on mobile"},{"text":"Vertical jump links expanded on mobile"},{"text":"Vertical jump links toggle text on mobile"},{"text":"Horizontal jump links"},{"text":"Jump links in drawer"},{"text":"Jump links in expanded drawer"}]],
    fullscreenExamples: ["Vertical jump links collapsed on mobile","Vertical jump links expanded on mobile","Vertical jump links toggle text on mobile","Horizontal jump links","Jump links in drawer","Jump links in expanded drawer"],
    section: "components",
    source: "html-demos",
  ...
  '/components/masthead/html-demos': {
    id: "Masthead",
    title: "Masthead",
    toc: [{"text":"Examples"},[{"text":"Basic"},{"text":"With context selector and dropdown"},{"text":"With toolbar, filters"},{"text":"With toggle group and filters"},{"text":"Advanced integration with menu options"},{"text":"Horizontal nav"}],{"text":"Mobile examples"},[{"text":"With toggle group, filters, expandable content expanded (mobile)"}]],
    fullscreenExamples: ["Basic","With context selector and dropdown","With toolbar, filters","With toggle group and filters","Advanced integration with menu options","Horizontal nav","With toggle group, filters, expandable content expanded (mobile)"],
    section: "components",
    source: "html-demos",
  ...
  '/components/page/html-demos': {
    id: "Page",
    title: "Page",
    toc: [{"text":"Demos"},[{"text":"Basic"},{"text":"Sticky horizontal subnav"},{"text":"Sticky breadcrumb"},{"text":"Sticky breadcrumb on medium"},{"text":"Sticky section group"},{"text":"Sticky section bottom"},{"text":"Overflow scroll"},{"text":"Centered section"}],{"text":"Documentation"}],
    fullscreenExamples: ["Basic","Sticky horizontal subnav","Sticky breadcrumb","Sticky breadcrumb on medium","Sticky section group","Sticky section bottom","Overflow scroll","Centered section"],
    section: "components",
    source: "html-demos",
  ...
  '/components/table/html-demos': {
    id: "Table",
    title: "Table",
    toc: [{"text":"Demos"},[{"text":"Basic"},{"text":"Sortable"},{"text":"Expandable"},{"text":"Compact"},{"text":"Compound expansion"},{"text":"Loading state demo"},{"text":"Empty state"},{"text":"Static bottom pagination"},{"text":"Column management modal"},{"text":"Sticky header"},{"text":"Sticky first column"},{"text":"Sticky multiple columns"},{"text":"Sticky header and multiple columns"},{"text":"Cell with image alignment"}]],
    fullscreenExamples: ["Basic","Sortable","Expandable","Compact","Compound expansion","Loading state demo","Empty state","Static bottom pagination","Column management modal","Sticky header","Sticky first column","Sticky multiple columns","Sticky header and multiple columns","Cell with image alignment"],
    section: "components",
    source: "html-demos",
  ...
  '/components/toolbar/html-demos': {
    id: "Toolbar",
    title: "Toolbar",
    toc: [{"text":"Demos"},[{"text":"Toolbar attribute value search filter desktop"},{"text":"Toolbar attribute value search filter on mobile"},{"text":"Toolbar attribute value single select filter desktop"},{"text":"Toolbar attribute value single select filter on mobile"},{"text":"Toolbar attribute value checkbox select filter desktop"},{"text":"Toolbar attribute value checkbox select filter on mobile"},{"text":"Toolbar pagination management on mobile"}]],
    ...
    fullscreenExamples: ["Toolbar pagination management on mobile"],
    section: "components",
    source: "html-demos",
  ...
  '/components/wizard/html-demos': {
    id: "Wizard",
    title: "Wizard",
    toc: [{"text":"Demos"},[{"text":"Basic"},{"text":"Nav expanded (mobile)"},{"text":"With drawer, closed"},{"text":"With drawer, expanded"},{"text":"With drawer and informational step"},{"text":"In page"},{"text":"In page nav expanded (mobile)"},{"text":"With drawer, in page"}]],
    fullscreenExamples: ["Basic","Nav expanded (mobile)","With drawer, closed","With drawer, expanded","With drawer and informational step","In page","In page nav expanded (mobile)","With drawer, in page"],
    section: "components",
    source: "html-demos",
  ...
  '/developer-resources/release-notes/html': {
    id: "Release notes",
    title: "Release notes",
    toc: [{"text":"2022.08 release notes (2022-06-24)"},[{"text":"Components"}],{"text":"2022.07 release notes (2022-06-03)"},[{"text":"Components","id":"components-0"},{"text":"Other"}],{"text":"2022.06 release notes (2022-05-13)"},[{"text":"Components","id":"components-1"},{"text":"Other","id":"other-0"}],{"text":"2022.05 release notes (2022-04-20)"},[{"text":"Components","id":"components-2"},{"text":"Other","id":"other-1"}],{"text":"2022.04 release notes (2022-03-30)"},[{"text":"Components","id":"components-3"},{"text":"Other","id":"other-2"}],{"text":"2022.03 release notes (2022-03-08)"},[{"text":"Components","id":"components-4"},{"text":"Other","id":"other-3"}],{"text":"2022.02 release notes (2022-02-17)"},[{"text":"Components","id":"components-5"},{"text":"Other","id":"other-4"}],{"text":"2022.01 release notes (2022-01-25)"},[{"text":"Components","id":"components-6"},{"text":"Other","id":"other-5"}],{"text":"2021.16 release notes (2021-12-07)"},[{"text":"Components","id":"components-7"},{"text":"Other","id":"other-6"}],{"text":"2021.15 release notes (2021-11-16)"},[{"text":"Components","id":"components-8"},{"text":"Other","id":"other-7"}],{"text":"2021.14 release notes (2021-10-26)"},[{"text":"Components","id":"components-9"},{"text":"Other","id":"other-8"}],{"text":"2021.13 release notes (2021-10-13)"},[{"text":"Components","id":"components-10"},{"text":"Other","id":"other-9"}],{"text":"2021.12 release notes (2021-09-14)"},[{"text":"Components","id":"components-11"},{"text":"Other","id":"other-10"}],{"text":"2021.11 release notes (2021-08-24)"},[{"text":"Components","id":"components-12"},{"text":"Other","id":"other-11"}],{"text":"2021.10 release notes (2021-08-03)"},[{"text":"Components","id":"components-13"},{"text":"Other","id":"other-12"}],{"text":"2021.08 release notes (2021-06-22)"},[{"text":"Components","id":"components-14"},{"text":"Other","id":"other-13"}],{"text":"2021.07 release notes (2021-06-04)"},[{"text":"Components","id":"components-15"},{"text":"Other","id":"other-14"}],{"text":"2021.06 release notes (2021-05-14)"},[{"text":"Components","id":"components-16"}],{"text":"2021.05 release notes (2021-04-20)"},[{"text":"Components","id":"components-17"},{"text":"Other","id":"other-15"}],{"text":"2021.04 release notes (2021-03-30)"},[{"text":"Components","id":"components-18"},{"text":"Other","id":"other-16"}],{"text":"2021.03 release notes (2021-03-09)"},[{"text":"Components","id":"components-19"}],{"text":"2021.02 release notes (2021-02-17)"},[{"text":"Components","id":"components-20"},{"text":"Other","id":"other-17"}],{"text":"2021.01 release notes (2021-01-26)"},[{"text":"Components","id":"components-21"},{"text":"Other","id":"other-18"}],{"text":"2020.16 release notes (2020-12-08)"},[{"text":"Components","id":"components-22"},{"text":"Layouts"},{"text":"Other","id":"other-19"}],{"text":"2020.15 release notes (2020-11-17)"},[{"text":"Components","id":"components-23"},{"text":"Other","id":"other-20"}],{"text":"2020.14 release notes (2020-10-27)"},[{"text":"Components","id":"components-24"},{"text":"Other","id":"other-21"}],{"text":"2020.13 release notes (2020-10-06)"},[{"text":"Components","id":"components-25"},{"text":"Layouts","id":"layouts-0"},{"text":"Other","id":"other-22"}],{"text":"2020.12 release notes (2020-09-17)"},[{"text":"Components","id":"components-26"},{"text":"Other","id":"other-23"}],{"text":"2020.11 release notes (2020-08-26)"},[{"text":"Components","id":"components-27"},{"text":"Other","id":"other-24"}],{"text":"2020.10 release notes (2020-08-17)"},[{"text":"Components","id":"components-28"},{"text":"Other","id":"other-25"}],{"text":"2020.09 release notes (2020-07-16)"},[{"text":"Components","id":"components-29"},{"text":"Other","id":"other-26"}],{"text":"2020.08 release notes (2020-06-24)"},[{"text":"Components","id":"components-30"},{"text":"Other","id":"other-27"}],{"text":"2020.07 release notes (2020-06-05)"},{"text":"2020.06 release notes (2020-05-12)"},[{"text":"Other","id":"other-28"}],{"text":"2020.05 release notes (2020-04-21)"},[{"text":"Other","id":"other-29"}],{"text":"2020.04 release notes (2020-03-31)"},[{"text":"Components","id":"components-31"},{"text":"Other","id":"other-30"}],{"text":"2020.03 release notes (2020-03-10)"},[{"text":"Components","id":"components-32"},{"text":"Other","id":"other-31"}],{"text":"2020.02 release notes (2020-02-18)"},[{"text":"Components","id":"components-33"},{"text":"Other","id":"other-32"}],{"text":"2020.01 release notes (2020-01-28)"},[{"text":"Components","id":"components-34"},{"text":"Other","id":"other-33"}],{"text":"2019.11 release notes (2019-12-18)"},[{"text":"Components","id":"components-35"},{"text":"Other","id":"other-34"}],{"text":"2019.10 release notes (2019-11-25)"},[{"text":"Components","id":"components-36"},{"text":"Other","id":"other-35"}],{"text":"2019.09 release notes (2019-11-01)"},[{"text":"Components","id":"components-37"},{"text":"Other","id":"other-36"}],{"text":"2019.08 release notes (2019-10-01)"},[{"text":"Components","id":"components-38"},{"text":"Other","id":"other-37"}],{"text":"2019.07 release notes (2019-09-10)"},[{"text":"Components","id":"components-39"},{"text":"Other","id":"other-38"}],{"text":"2019.06 release notes (2019-08-13)"},[{"text":"Components","id":"components-40"},{"text":"Chore"}],{"text":"2019.05 release notes (2019-07-24)"},[{"text":"Components","id":"components-41"},{"text":"Other","id":"other-39"}],{"text":"2019.04 release notes (2019-07-02)"},[{"text":"Components","id":"components-42"},{"text":"Other","id":"other-40"}],{"text":"2019.03 RC2.1 release notes (2019-06-11)"},[{"text":"Components","id":"components-43"}],{"text":"2019.02 release notes (2019-05-28)"},[{"text":"Components","id":"components-44"},{"text":"Layouts","id":"layouts-1"},{"text":"Other","id":"other-41"}]],
    section: "developer-resources",
    source: "html",
