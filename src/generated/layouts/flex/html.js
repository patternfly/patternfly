...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/patternfly/patternfly/dist/docs/layouts/Flex/examples/Flex.md",
  "cssPrefix": [
    "pf-l-flex"
  ],
  "examples": [
...
const Component = () => (
  <React.Fragment>
    ...
    {React.createElement(pageData.examples["Ordering example"])}
