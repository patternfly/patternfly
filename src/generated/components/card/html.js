...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/patternfly/patternfly/dist/docs/components/Card/examples/Card.md",
  "cssPrefix": [
    "pf-c-card"
  ],
  "examples": [
...
const Component = () => (
  <React.Fragment>
    ...
    {React.createElement(pageData.examples["Selectable with a hidden input for improved screen reader accessibility"])}
    ...
    <table {...{"className":"ws-table pf-c-table pf-m-grid-lg pf-m-compact","role":"grid"}}>
      ...
      <tbody {...{"role":"rowgroup"}}>
        ...
        <tr {...{"role":"row"}}>
          ...
          <td {...{"role":"cell","data-label":"Outcome"}}>
            <div>
              {`Creates an input which, when focused, makes a following `}
              <code {...{"className":"ws-code"}}>
                {`.pf-c-card`}
              </code>
              {` appear focused.`}
