...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/source/patternfly/dist/docs/components/Toolbar/examples/Toolbar.md",
  "cssPrefix": [
    "pf-c-toolbar"
  ],
  "examples": [
    ...
    <table {...{"className":"ws-table pf-c-table pf-m-grid-lg pf-m-compact","role":"grid"}}>
      ...
      <tbody {...{"role":"rowgroup"}}>
        ...
        <tr {...{"role":"row"}}>
          ...
          <td {...{"role":"cell","data-label":"Outcome"}}>
            <div>
              {`Modifies the min width value of a toolbar item.`}
            </div>
          </td>
        </tr>
      </tbody>
