...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/patternfly/patternfly/dist/docs/components/JumpLinks/examples/JumpLinks.md",
  "cssPrefix": [
    "pf-c-jump-links"
  ],
  "examples": [
    ...
    <table {...{"className":"ws-table pf-c-table pf-m-grid-lg pf-m-compact","role":"grid"}}>
      ...
      <tbody {...{"role":"rowgroup"}}>
        ...
        <tr {...{"role":"row"}}>
          ...
          <td {...{"role":"cell","data-label":"Outcome"}}>
            <div>
              {`Modifies the jump links component to be expandable via a toggle at optional `}
        ...
        <tr {...{"role":"row"}}>
          ...
          <td {...{"role":"cell","data-label":"Outcome"}}>
            <div>
              {`Modifies the jump links component to be non-expandable at optional `}
              <PatternflyThemeLink {...{"to":"/developer-resources/global-css-variables#breakpoint-variables-and-class-suffixes"}}>
                {`breakpoint`}
              </PatternflyThemeLink>
              {`.`}
