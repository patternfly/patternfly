...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/source/patternfly/dist/docs/components/NotificationBadge/examples/NotificationBadge.md",
  "cssPrefix": [
...
const Component = () => (
  <React.Fragment>
    ...
    <p {...{"className":"ws-p"}}>
      ...
      <PatternflyThemeLink {...{"to":"../masthead"}}>
        {`masthead`}
      </PatternflyThemeLink>
      {`.`}
    </p>
