...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/source/patternfly/dist/docs/components/Truncate/examples/Truncate.md",
  "beta": true,
  "cssPrefix": [
    "pf-c-truncate"
  ],
    ...
    <table {...{"className":"ws-table pf-c-table pf-m-grid-lg pf-m-compact","role":"grid"}}>
      ...
      <tbody {...{"role":"rowgroup"}}>
        ...
        <tr {...{"role":"row"}}>
          ...
          <td {...{"role":"cell","data-label":"Outcome"}}>
            <div>
              {`Defines the truncate component text.`}
            </div>
          </td>
        </tr>
      </tbody>
