...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/patternfly/patternfly/dist/docs/components/Form/examples/Form.md",
  "cssPrefix": [
    "pf-c-form"
  ],
  "examples": [
...
const Component = () => (
  <React.Fragment>
    ...
    {React.createElement(pageData.examples["Field group (non-expandable)"])}
    {React.createElement(pageData.examples["Expandable and nested field groups"])}
