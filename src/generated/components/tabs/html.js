...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/patternfly/patternfly/dist/docs/components/Tabs/examples/Tabs.md",
  "cssPrefix": [
    "pf-c-tabs"
  ],
  "examples": [
...
const Component = () => (
  <React.Fragment>
    ...
    {React.createElement(pageData.examples["Horizontal overflow expanded"])}
    {React.createElement(pageData.examples["Horizontal overflow selected"])}
    ...
    <table {...{"className":"ws-table pf-c-table pf-m-grid-lg pf-m-compact","role":"grid"}}>
      ...
      <tbody {...{"role":"rowgroup"}}>
        ...
        <tr {...{"role":"row"}}>
          ...
          <td {...{"role":"cell","data-label":"Outcome"}}>
            <div>
              {`Indicates that the overflow menu tab is expanded. `}
              <strong>
