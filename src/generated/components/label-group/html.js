...
const pageData = {
  ...
  "sourceLink": "https://github.com/patternfly/patternfly/blob/main/patternfly/patternfly/dist/docs/components/LabelGroup/examples/LabelGroup.md",
  "beta": true,
  "cssPrefix": [
    "pf-c-label-group"
  ],
...
const Component = () => (
  <React.Fragment>
    ...
    {React.createElement(pageData.examples["Mixed labels (static / editable), dynamic label group"])}
    {React.createElement(pageData.examples["Compact labels"])}
    {React.createElement(pageData.examples["Compact labels, overflow"])}
    {React.createElement(pageData.examples["Compact labels, vertical"])}
