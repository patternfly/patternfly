...
const pageData = {
  ...
  sourceLink: 'https://github.com/patternfly/patternfly/blob/main/Code/patternfly/dist/docs/components/Backdrop/examples/Backdrop.md',
  cssPrefix: [
    'pf-c-backdrop'
  ],
  fullscreenExamples: [
...
pageData.examples = {
  Basic: props =>
    <Example {...pageData} {...props} {...{ code: '<div class="pf-c-backdrop"></div>', title: 'Basic', lang: 'html', isFullscreen: true }} />
};
