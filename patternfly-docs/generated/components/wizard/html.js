...
const pageData = {
  ...
  sourceLink: 'https://github.com/patternfly/patternfly/blob/main/Code/patternfly/dist/docs/components/Wizard/examples/Wizard.md',
  cssPrefix: [
    'pf-c-wizard'
  ],
  fullscreenExamples: [
