...
const relativeUrls = [
  ...
  '/components/drawer/html-demos/collapsed-drawer-with-jump-links',
  ...
  '/components/forms/form/html/label-with-additional-info-horizontal-form',
  ...
  '/components/menus/menu-toggle/html/split-toggle-with-checkbox',
  '/components/menus/menu-toggle/html/split-toggle-with-checkbox-and-toggle-text',
  '/components/menus/menu-toggle/html/split-toggle-with-labeled-checkbox',
  ...
  '/components/page/html-demos/context-selector-expanded-in-sidebar',
  ...
  '/components/panel/html-demos/with-a-menu',
  ...
  '/components/switch/html/label-and-check-icon',
  '/components/switch/html/reverse-toggle-on-right',
  '/components/switch/html/without-visible-text-label',
  ...
  '/components/text-input-group/html/plain',
  ...
  '/components/text-input-group/html/with-validation',
  ...
  '/components/toolbar/html/action-group',
  '/components/toolbar/html/action-group-inline',
  '/components/toolbar/html/action-group-plain',
  '/components/toolbar/html/adjusted-group-column-gap',
  '/components/toolbar/html/filter-group',
  '/components/toolbar/html/insets',
  '/components/toolbar/html/label-group',
  ...
  '/components/toolbar/html/toggle-group-on-desktop',
  ...
  '/components/tree-view/html/multiselectable',
  '/components/tree-view/html/single-selectable',
  ...
  '/components/wizard/html/nav-expanded-with-success-mobile',
  '/components/wizard/html/success-on-step',
