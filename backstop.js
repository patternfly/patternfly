...
module.exports = {
  ...
  engine: 'puppeteer',
  engineOptions: {
    // executablePath: "/Users/cmichael/Desktop/chrome-122/Chromium.app/Contents/MacOS/Chromium", // tells puppeteer to use a specific browser instead of the default that comes with puppeteer
    headless: 'new',
    args: [
      '--no-sandbox',
