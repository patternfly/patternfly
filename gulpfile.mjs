...
const hbsFiles = ['./src/patternfly/*.hbs', './src/patternfly/**/*.hbs', './src/patternfly/**/**/*.hbs'];
const mdFiles = ['./src/patternfly/**/*.md'];
const helperFiles = ['./scripts/init.mjs', './scripts/params.mjs', './scripts/helpers.mjs', './src/components/**/**/*.mjs'];
